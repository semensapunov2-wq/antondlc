--// Rayfield UI Library
local Rayfield = loadstring(game:HttpGet("https://raw.githubusercontent.com/semensapunov2-wq/antondlc/refs/heads/main/rayfieldui.lua"))()
...
local Window = Rayfield:CreateWindow({
    Name = "AntonDLC",
    Icon = 0,
    LoadingTitle = "loading AntonDLC",
    LoadingSubtitle = "by tayex",
    ShowText = "Menu",
    Theme = {
...
Tab_Combat:CreateToggle({Name = "Enable Bhop", CurrentValue = false, Flag = "BhopToggle", Callback = function(Value) BhopEnabled = Value end})
...
Tab_Skins:CreateToggle({Name = "Enable Skin Changer", CurrentValue = false, Flag = "SkinChangerToggle", Callback = function(Value)
...
Tab_Skins:CreateToggle({Name = "Enable Custom Knife", CurrentValue = false, Flag = "KnifeToggle", Callback = function(Value)
    scriptRunning = Value
...
Tab_Visuals:CreateSection("Player Chams")
Tab_Visuals:CreateToggle({Name = "Enable Player Chams", CurrentValue = false, Flag = "ChamsToggle", Callback = function(Value)
    ChamsEnabled = Value
    if not Value then for _, hl in pairs(chamsCache) do hl:Destroy() end chamsCache = {} end
end})
...
Tab_Visuals:CreateSection("Particles")
...
Tab_Visuals:CreateButton({Name = "Save Current Config", Callback = function()
    Rayfield:SaveConfiguration()
    Rayfield:Notify({Title = "Config Saved", Content = "Settings saved successfully!", Duration = 3})
end})

Tab_Visuals:CreateButton({Name = "Load Last Config", Callback = function()
    Rayfield:LoadConfiguration()
    Rayfield:Notify({Title = "Config Loaded", Content = "Last config loaded.", Duration = 3})
end})
